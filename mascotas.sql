...
CREATE TABLE IF NOT EXISTS `mydb`.`Raza` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Raza_TipoMascota_idx` (`TipoMascota_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Mascota` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Mascota_User1_idx` (`User_id` ASC) ,
  INDEX `fk_Mascota_TipoMascota1_idx` (`TipoMascota_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ControlVacuna` (
  ...
  INDEX `fk_Mascota_has_Vacuna_Vacuna1_idx` (`Vacuna_id` ASC) ,
  INDEX `fk_Mascota_has_Vacuna_Mascota1_idx` (`Mascota_id` ASC) ,
